...
#ifndef _NB_SERVER_H_INCLUDED
#define _NB_SERVER_H_INCLUDED
...
class NBServer : public Server, public ModemUrcHandler {
...
public:
   ...
   */
  NBServer(uint16_t port, bool synch = true);
  ...
  */
  NBClient available(bool synch = true);
